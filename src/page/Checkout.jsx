...
export default function Checkout() {
  ...
  const handleStaticABAPayment = () => {
    ...
    const merchantId = "12345678"; // Replace with your sandbox merchant_id
    ...
    const hash = "5f4dcc3b5aa765d61d8327deb882cf99"; // Replace with your own computed hash
            ...
            <div className="row">
              <div className="col-lg-8">
                ...
                <form className="row contact_form" action="#" method="post" noValidate="novalidate">
                  ...
                  <div className="col-md-12 form-group p_star">
                    <input type="text" className="form-control" id="add" name="add" />
                    <span className="placeholder" data-placeholder="Address line" />
                  </div>
                  <div className="col-md-12 form-group p_star">
              ...
              <div className="col-lg-4">
                <div className="order_box">
                  ...
                  <PayPalScriptProvider options={{ "client-id": "ASLMGKdtntQ5vKqo-ehR6BwiW4xQWjAbhtrx5J5XBgE6vU7c4xyanrx8_pFkphseiA-rNJn3OUTduAap" }}>
                    <PayPalButtons
                  ...
                  {/* ABA PayWay Button */}
                  <button className="btn_3 mt-3 w-100" onClick={handleStaticABAPayment}>
                    Pay with ABA PayWay
                  </button>
                </div>
              </div>
